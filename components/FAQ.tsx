...
const faqs = [
  {
    ...
    answer:
      "The ceremony time will be shared on your invitation. We kindly ask guests to arrive 30 minutes early to allow time to get settled.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl border-[14px] border-[#666634] px-6 py-12 md:px-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-[260px_1fr] md:items-center">
          <div className="flex justify-center md:justify-start">
            <h2 className="font-serif text-7xl leading-none text-[#2f2b13] md:-rotate-90 md:text-9xl">
              FAQ
            </h2>
          </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="grid gap-4 sm:grid-cols-[48px_1fr]">
                  <p className="font-sans text-lg font-semibold tracking-[0.08em]">
                    {String(index + 1).padStart(2, "0")}
                  </p>

                  <div>
                    <h3 className="font-sans text-xl text-[#1f1d1a] md:text-2xl">
                      {faq.question}
                    </h3>

                    <p className="mt-5 max-w-2xl font-serif text-lg italic leading-8 text-[#3f3a32]">
                      {faq.answer}
                    </p>
                  </div>
                </div>
