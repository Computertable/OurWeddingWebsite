  ...
  return (
    <section className="px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        >
          <p className="font-sans text-[10px] uppercase tracking-[0.4em] text-[#A8A696] sm:text-[10px] sm:tracking-[0.5em]">
            Kindly Respond
          </p>
          ...
          <div className="mx-auto mt-7 flex items-center justify-center gap-3 sm:mt-8 sm:gap-4">
            ...
            <p className="font-sans text-[10px] uppercase tracking-[0.22em] text-[#A8A696] sm:text-[10px] sm:tracking-[0.3em]">
        ...
        >
          ...
          <p className="mt-5 text-center font-display text-md italic text-[#A8A696]">
